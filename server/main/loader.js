...
const Loader = function (logger, configMain) {
  ...
  this.handleConfigs = function () {
    ...
    if (fs.existsSync(normalizedPath + "satoxcoin.js")) {
      config = require(normalizedPath + "satoxcoin.js");
      ...
      throw new Error(
        "Unable to find satoxcoin.js file. Read the installation/setup instructions"
      );
    }
    return config;
  };
