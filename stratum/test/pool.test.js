...
config.primary.recipients[0].address = "RHUC17zAVjNqXDtkqwLPRvQ2XgoRZsXeeG";
      ...
      JSON.stringify([
        {
          ...
          result: {
            isvalid: true,
            address: "RHUC17zAVjNqXDtkqwLPRvQ2XgoRZsXeeG",
          },
        },
...
function mockClient() {
  ...
  client.id = "test";
  client.addrPrimary = "RHUC17zAVjNqXDtkqwLPRvQ2XgoRZsXeeG";
...
describe("Test pool functionality", () => {
      ...
      if (type !== "debug") {
        ...
        if (response.length === 2) {
          ...
          expect(response[0][1]).toBe(
            "Submitted a primary block (Satoxcoin:1) successfully to Satoxcoin's daemon instance(s)"
          );
    ...
    pool.on("pool.log", (type, text) => {
      if (type !== "debug") {
        ...
        if (response.length === 2) {
          ...
          expect(response[1][1]).toBe(
            "Requested template from primary chain (Satoxcoin:2) via RPC polling"
          );
          done();
        }
      }
      ...
      if (type !== "debug") {
        ...
        if (response.length === 3) {
          ...
          expect(response[2][1]).toBe(
            "Requested template from primary chain (Satoxcoin:1) via RPC polling"
          );
          done();
        }
      }
    ...
    pool.on("pool.log", (type, text) => {
      if (type !== "debug") {
        ...
        if (response.length === 2) {
          ...
          expect(response[1][0]).toBe("log");
          expect(response[1][1]).toBe(
            "Difficulty update queued for worker: RHUC17zAVjNqXDtkqwLPRvQ2XgoRZsXeeG (8)"
          );
          pool.network.stopNetwork();
        }
      }
    ...
    pool.on("pool.log", (type, text) => {
      if (type !== "debug") {
        ...
        if (response.length === 2) {
          ...
          expect(response[1][0]).toBe("log");
          expect(response[1][1]).toBe(
            "Difficulty updated successfully for worker: RHUC17zAVjNqXDtkqwLPRvQ2XgoRZsXeeG (8)"
          );
          pool.network.stopNetwork();
        }
      }
  ...
  test("Test pool stratum authentication [2]", (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkWorker(
        pool.primary.daemon,
        "RHUC17zAVjNqXDtkqwLPRvQ2XgoRZsXeeG.worker1",
        (valid) => {
          expect(valid).toBe(true);
          done();
        }
  ...
  test("Test pool workers handling [1]", () => {
    ...
    const blocks1 = {
      ...
      miner: "RHUC17zAVjNqXDtkqwLPRvQ2XgoRZsXeeG",
      worker: "RHUC17zAVjNqXDtkqwLPRvQ2XgoRZsXeeG.worker1",
      category: "immature",
      confirmations: 3,
    ...
    const worker1 = {
      ...
      miner: "RHUC17zAVjNqXDtkqwLPRvQ2XgoRZsXeeG",
      worker: "RHUC17zAVjNqXDtkqwLPRvQ2XgoRZsXeeG.worker4",
      identifier: "master",
      invalid: 0,
      round: "15c8343c-9751-4c67-aafa-29ff296da484",
      solo: false,
    ...
    const expected = {
      RHUC17zAVjNqXDtkqwLPRvQ2XgoRZsXeeG: { immature: 10000, generate: 0 },
    };
  ...
  test("Test pool workers handling [2]", () => {
    ...
    const expected = {
      RHUC17zAVjNqXDtkqwLPRvQ2XgoRZsXeeG: { generate: 0, immature: 20000 },
    };
  ...
  test("Test pool workers handling [3]", () => {
    ...
    const expected = {
      RHUC17zAVjNqXDtkqwLPRvQ2XgoRZsXeeG: { immature: 5000, generate: 0 },
  ...
  test("Test pool workers handling [4]", () => {
    ...
    const expected = {
      ...
      RHUC17zAVjNqXDtkqwLPRvQ2XgoRZsXeeH: {
  ...
  test("Test pool workers handling [5]", () => {
    ...
    const expected = {
      RHUC17zAVjNqXDtkqwLPRvQ2XgoRZsXeeG: { generate: 10000, immature: 0 },
    };
    pool.handlePrimaryWorkers([blocks1], [[worker1]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  ...
  test("Test pool workers handling [6]", () => {
    ...
    const expected = {
      RHUC17zAVjNqXDtkqwLPRvQ2XgoRZsXeeG: { immature: 0, generate: 20000 },
    };
    pool.handlePrimaryWorkers(
      [blocks1, blocks1],
      [[worker1], [worker1]],
  ...
  test("Test pool workers handling [9]", () => {
    ...
    const expected = {
      RHUC17zAVjNqXDtkqwLPRvQ2XgoRZsXeeG: { immature: 0, generate: -10000 },
    };
    pool.handlePrimaryWorkers([blocks1], [[worker1]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  ...
  test("Test pool workers handling [14]", () => {
    ...
    const expected = {
      RHUC17zAVjNqXDtkqwLPRvQ2XgoRZsXeeG: { immature: -10000, generate: 10000 },
    };
    pool.handlePrimaryWorkers([blocks1], [[worker1]], true, (results) => {
      expect(results).toStrictEqual(expected);
    });
